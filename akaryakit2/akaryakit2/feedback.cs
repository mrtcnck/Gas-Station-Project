...
namespace akaryakit2
{
    public partial class feedback : Form
    {
        ...
        private void txt_sifreyenile_TextChanged(object sender, EventArgs e)
        {
            txt_sifreyenile.MaxLength = 16;
        }

        private void txt_resifre_TextChanged(object sender, EventArgs e)
        {
        ...
        {
            txt_kullanici.Text = giris.kullanici;
        }
    }
}
